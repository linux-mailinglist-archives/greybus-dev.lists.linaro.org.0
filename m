...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 8306C674A70
	for <lists+greybus-dev@lfdr.de>; Fri, 20 Jan 2023 05:03:07 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 90BD23F07C
	for <lists+greybus-dev@lfdr.de>; Fri, 20 Jan 2023 04:03:06 +0000 (UTC)
Received: from NAM12-DM6-obe.outbound.protection.outlook.com (mail-dm6nam12on2089.outbound.protection.outlook.com [40.107.243.89])
	by lists.linaro.org (Postfix) with ESMTPS id 430803EF35
	for <greybus-dev@lists.linaro.org>; Thu, 19 Jan 2023 18:57:43 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=SvCWYM+T;
	spf=pass (lists.linaro.org: domain of amit.kumar-mahapatra@amd.com designates 40.107.243.89 as permitted sender) smtp.mailfrom=amit.kumar-mahapatra@amd.com;
...
X-Rspamd-Queue-Id: 430803EF35
X-Spamd-Bar: ---
X-MailFrom: amit.kumar-mahapatra@amd.com
X-Mailman-Rule-Hits: max-recipients
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-size; news-moderation; no-subject; digests; suspicious-header
Message-ID-Hash: QHSFHOJKSGVWE2BIEGETZZSFR53NIPLN
X-Message-ID-Hash: QHSFHOJKSGVWE2BIEGETZZSFR53NIPLN
...
Precedence: list
Subject: [greybus-dev] [PATCH v2 08/13] spi: Add stacked and parallel memories support in SPI core
List-Id: Greybus Development Mail List <greybus-dev.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/greybus-dev@lists.linaro.org/message/QHSFHOJKSGVWE2BIEGETZZSFR53NIPLN/>
