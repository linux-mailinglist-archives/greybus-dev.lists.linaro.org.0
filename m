...
Received: from mail.lfdr.de
	...
	id ChLZCVGTJmrdYwIAu9opvQ
	(envelope-from <greybus-dev-bounces+lists+greybus-dev=lfdr.de@lists.linaro.org>)
	for <lists+greybus-dev@lfdr.de>; Mon, 08 Jun 2026 12:02:57 +0200
X-Original-To: lists+greybus-dev@lfdr.de
Received: from lists.linaro.org (lists.linaro.org [44.210.186.118])
	by mail.lfdr.de (Postfix) with ESMTPS id C0DA2654D2E
	for <lists+greybus-dev@lfdr.de>; Mon, 08 Jun 2026 12:02:56 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=fail ("body hash did not verify") header.d=kernel.org header.s=k20260515 header.b=bX+7EF1A;
	spf=pass (mail.lfdr.de: domain of "greybus-dev-bounces+lists+greybus-dev=lfdr.de@lists.linaro.org" designates 44.210.186.118 as permitted sender) smtp.mailfrom="greybus-dev-bounces+lists+greybus-dev=lfdr.de@lists.linaro.org";
	dmarc=fail reason="SPF not aligned (relaxed)" header.from=kernel.org (policy=quarantine)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id DF9D7401BA
	for <lists+greybus-dev@lfdr.de>; Mon,  8 Jun 2026 10:02:55 +0000 (UTC)
Received: from tor.source.kernel.org (tor.source.kernel.org [172.105.4.254])
	by lists.linaro.org (Postfix) with ESMTPS id 8BC7E401BA
	for <greybus-dev@lists.linaro.org>; Mon,  8 Jun 2026 10:02:51 +0000 (UTC)
Received: from smtp.kernel.org (quasi.space.kernel.org [100.103.45.18])
	by tor.source.kernel.org (Postfix) with ESMTP id 4BE8A601D8;
...
MIME-Version: 1.0
X-Spamd-Bar: --
Message-ID-Hash: 2U3CIBFGTFBGWMNZX6VO5EKUMSSCGT64
X-Message-ID-Hash: 2U3CIBFGTFBGWMNZX6VO5EKUMSSCGT64
...
Precedence: list
Subject: [greybus-dev] [linux-5.10.y 2/3] HID: pass the buffer size to hid_report_raw_event
List-Id: Greybus Development Mail List <greybus-dev.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/greybus-dev@lists.linaro.org/message/2U3CIBFGTFBGWMNZX6VO5EKUMSSCGT64/>
