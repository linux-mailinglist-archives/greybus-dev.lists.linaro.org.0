...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 59B0780A7B3
	for <lists+greybus-dev@lfdr.de>; Fri,  8 Dec 2023 16:41:51 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id C2DCB3F953
	for <lists+greybus-dev@lfdr.de>; Fri,  8 Dec 2023 15:41:49 +0000 (UTC)
Received: from mail-lf1-f47.google.com (mail-lf1-f47.google.com [209.85.167.47])
	by lists.linaro.org (Postfix) with ESMTPS id 2C8323F029
	for <greybus-dev@lists.linaro.org>; Fri,  8 Dec 2023 15:41:43 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=gmail.com header.s=20230601 header.b=ZyHlHd0B;
...
Received: by mail-lf1-f47.google.com with SMTP id 2adb3069b0e04-50c05ea5805so2629680e87.0
        for <greybus-dev@lists.linaro.org>; Fri, 08 Dec 2023 07:41:43 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1702050102; x=1702654902; darn=lists.linaro.org;
        h=user-agent:in-reply-to:content-disposition:mime-version:references
         :message-id:subject:cc:to:from:date:from:to:cc:subject:date
         :message-id:reply-to;
        bh=cRlnGJEkFIcfd0ts9iL+JgmFXWbUsRLWy8OoDP8slcg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=cRlnGJEkFIcfd0ts9iL+JgmFXWbUsRLWy8OoDP8slcg=;
        b=
X-Gm-Message-State: AOJu0YwqPIPyaPYU7xiRWvyyXJG9il1tvKQr3BdPBVWi6e/SErtNQQfA
	rbMeKFrzeUFyHeAaT26I+NA=
...
Message-ID-Hash: QR6CDMZOARYKQXENGX5ENHS7PMQOUQFY
X-Message-ID-Hash: QR6CDMZOARYKQXENGX5ENHS7PMQOUQFY
X-MailFrom: thierry.reding@gmail.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; digests; suspicious-header
CC: kernel@pengutronix.de, linux-pwm@vger.kernel.org, Bartosz Golaszewski <brgl@bgdev.pl>, linux-leds@vger.kernel.org, chrome-platform@lists.linux.dev, linux-arm-kernel@lists.infradead.org, linux-mips@vger.kernel.org, linux-mediatek@lists.infradead.org, linux-amlogic@lists.infradead.org, linux-rpi-kernel@lists.infradead.org, linux-samsung-soc@vger.kernel.org, linux-riscv@lists.infradead.org, linux-stm32@st-md-mailman.stormreply.com, linux-sunxi@lists.linux.dev, greybus-dev@lists.linaro.org, linux-staging@lists.linux.dev, linux-doc@vger.kernel.org, asahi@lists.linux.dev, platform-driver-x86@vger.kernel.org, linux-rockchip@lists.infradead.org, dri-devel@lists.freedesktop.org, linux-hardening@vger.kernel.org
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [greybus-dev] Re: [PATCH v4 000/115] pwm: Fix lifetime issues for pwm_chips
List-Id: Greybus Development Mail List <greybus-dev.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/greybus-dev@lists.linaro.org/message/QR6CDMZOARYKQXENGX5ENHS7PMQOUQFY/>
...
Content-Type: multipart/mixed; boundary="===============5078829709316495185=="
