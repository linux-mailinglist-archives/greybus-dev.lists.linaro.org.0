...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 8FA117B5A01
	for <lists+greybus-dev@lfdr.de>; Mon,  2 Oct 2023 20:26:48 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 935FC40D6A
	for <lists+greybus-dev@lfdr.de>; Mon,  2 Oct 2023 18:26:47 +0000 (UTC)
Received: from mail-oo1-f50.google.com (mail-oo1-f50.google.com [209.85.161.50])
	by lists.linaro.org (Postfix) with ESMTPS id 3D3DF40D69
	for <greybus-dev@lists.linaro.org>; Mon,  2 Oct 2023 18:26:36 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=gmail.com header.s=20230601 header.b=fFG9FrcD;
	spf=pass (lists.linaro.org: domain of ayushdevel1325@gmail.com designates 209.85.161.50 as permitted sender) smtp.mailfrom=ayushdevel1325@gmail.com;
	dmarc=pass (policy=none) header.from=gmail.com
Received: by mail-oo1-f50.google.com with SMTP id 006d021491bc7-57de9237410so32662eaf.0
        for <greybus-dev@lists.linaro.org>; Mon, 02 Oct 2023 11:26:36 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1696271195; x=1696875995; darn=lists.linaro.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=SriUj9w7hwJc6UKzrwavavOXBgjM3Dof91uJYFP4tkM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=SriUj9w7hwJc6UKzrwavavOXBgjM3Dof91uJYFP4tkM=;
        b=
X-Gm-Message-State: AOJu0YxJfz7FA9r+Malal24Xcz2Mgf8Zq10E0on6ElcsgBwS9WVAXW6u
	CdBO7uRYLep3lH1wSnAOJUgrusgtLOdAJQ==
...
X-Rspamd-Queue-Id: 3D3DF40D69
Message-ID-Hash: G3DCMOYSNADUUF246YUBGNPK6OAC7TDK
X-Message-ID-Hash: G3DCMOYSNADUUF246YUBGNPK6OAC7TDK
...
Precedence: list
Subject: [greybus-dev] [PATCH v6 2/3] greybus: Add BeaglePlay Linux Driver
List-Id: Greybus Development Mail List <greybus-dev.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/greybus-dev@lists.linaro.org/message/G3DCMOYSNADUUF246YUBGNPK6OAC7TDK/>
