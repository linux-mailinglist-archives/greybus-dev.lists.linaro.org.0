...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 95C26674A75
	for <lists+greybus-dev@lfdr.de>; Fri, 20 Jan 2023 05:03:30 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id A3A9A3F076
	for <lists+greybus-dev@lfdr.de>; Fri, 20 Jan 2023 04:03:29 +0000 (UTC)
Received: from NAM12-DM6-obe.outbound.protection.outlook.com (mail-dm6nam12on2086.outbound.protection.outlook.com [40.107.243.86])
	by lists.linaro.org (Postfix) with ESMTPS id 9B6283EF35
	for <greybus-dev@lists.linaro.org>; Thu, 19 Jan 2023 18:59:25 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=vYeBK6Dm;
	spf=pass (lists.linaro.org: domain of amit.kumar-mahapatra@amd.com designates 40.107.243.86 as permitted sender) smtp.mailfrom=amit.kumar-mahapatra@amd.com;
...
X-Spamd-Result: default: False [0.00 / 15.00];
 ...
 com,m:yogeshgaur.83@gmail.com,m:konrad.dybcio@somainline.org,m:alim.akhtar@samsung.com,m:ldewangan@nvidia.com,m:michal.simek@amd.com,m:linux-aspeed@lists.ozlabs.org,m:openbmc@lists.ozlabs.org,m:linux-arm-kernel@lists.infradead.org,m:linux-rpi-kernel@lists.infradead.org,m:linux-amlogic@lists.infradead.org,m:linux-mediatek@lists.infradead.org,m:linux-arm-msm@vger.kernel.org,m:linux-rockchip@lists.infradead.org,m:linux-samsung-soc@vger.kernel.org,m:linux-stm32@st-md-mailman.stormreply.com,m:linux-sunxi@lists.linux.dev,s:greybus-dev@lists.linaro.org];
	...
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.243.86:from];
...
X-Rspamd-Queue-Id: 9B6283EF35
X-Spamd-Bar: /
X-MailFrom: amit.kumar-mahapatra@amd.com
X-Mailman-Rule-Hits: max-recipients
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-size; news-moderation; no-subject; digests; suspicious-header
Message-ID-Hash: D53SCKIT3ZIBRVOS53TVDDIRV5BGK6IM
X-Message-ID-Hash: D53SCKIT3ZIBRVOS53TVDDIRV5BGK6IM
...
Precedence: list
Subject: [greybus-dev] [PATCH v2 12/13] mtd: spi-nor: Add parallel memories support in spi-nor
List-Id: Greybus Development Mail List <greybus-dev.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/greybus-dev@lists.linaro.org/message/D53SCKIT3ZIBRVOS53TVDDIRV5BGK6IM/>
