...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 982C5B03F62
	for <lists+greybus-dev@lfdr.de>; Mon, 14 Jul 2025 15:12:33 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 5EFA14122D
	for <lists+greybus-dev@lfdr.de>; Mon, 14 Jul 2025 13:12:32 +0000 (UTC)
Received: from smtp.forwardemail.net (smtp.forwardemail.net [149.28.215.223])
	by lists.linaro.org (Postfix) with ESMTPS id 416E84122D
	for <greybus-dev@lists.linaro.org>; Mon, 14 Jul 2025 13:12:29 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=ubuntu.com header.s=fe-953a8a3ca9 header.b=EhRtxneI;
	spf=pass (lists.linaro.org: domain of "SRS0=2073=Z4=ubuntu.com=schopin@fe-bounces.ubuntu.com" designates 149.28.215.223 as permitted sender) smtp.mailfrom="SRS0=2073=Z4=ubuntu.com=schopin@fe-bounces.ubuntu.com";
...
X-Spamd-Result: default: False [-2.20 / 15.00];
	...
	TO_DN_SOME(0.00)[];
	ASN(0.00)[asn:20473, ipnet:149.28.192.0/19, country:US];
	RWL_MAILSPIKE_POSSIBLE(0.00)[149.28.215.223:from];
	MIME_TRACE(0.00)[0:+];
	...
	URIBL_BLOCKED(0.00)[smtp.forwardemail.net:rdns,smtp.forwardemail.net:helo];
	DNSWL_BLOCKED(0.00)[149.28.215.223:from];
	DKIM_TRACE(0.00)[ubuntu.com:+]
X-Rspamd-Action: no action
Message-ID-Hash: R6KSBY3T332VRK7DOKFPM4IHEATOPYMP
X-Message-ID-Hash: R6KSBY3T332VRK7DOKFPM4IHEATOPYMP
...
Precedence: list
Subject: [greybus-dev] [PATCH] staging: greybus: fix whitespace alignments in firmware.c
List-Id: Greybus Development Mail List <greybus-dev.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/greybus-dev@lists.linaro.org/message/R6KSBY3T332VRK7DOKFPM4IHEATOPYMP/>
