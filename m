...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id AC19984757F
	for <lists+greybus-dev@lfdr.de>; Fri,  2 Feb 2024 17:59:58 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id AF26E40B1B
	for <lists+greybus-dev@lfdr.de>; Fri,  2 Feb 2024 16:59:57 +0000 (UTC)
Received: from smtp.smtpout.orange.fr (smtp-22.smtpout.orange.fr [80.12.242.22])
	by lists.linaro.org (Postfix) with ESMTPS id 7A8AA3EB98
	for <greybus-dev@lists.linaro.org>; Fri, 26 Jan 2024 17:39:33 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=wanadoo.fr header.s=t20230301 header.b=pyMXfiTR;
	dmarc=pass (policy=none) header.from=wanadoo.fr;
	spf=pass (lists.linaro.org: domain of christophe.jaillet@wanadoo.fr designates 80.12.242.22 as permitted sender) smtp.mailfrom=christophe.jaillet@wanadoo.fr
...
X-Spamd-Result: default: False [-1.30 / 15.00];
	...
	RWL_MAILSPIKE_EXCELLENT(-0.40)[80.12.242.22:from];
	...
	FREEMAIL_CC(0.00)[vger.kernel.org,wanadoo.fr,linaro.org,lists.linaro.org,lists.linux.dev];
...
Message-ID-Hash: JJF26GA4OUAYVHHSFYDW7ZB6PMJE42MP
X-Message-ID-Hash: JJF26GA4OUAYVHHSFYDW7ZB6PMJE42MP
X-Mailman-Approved-At: Fri, 02 Feb 2024 16:59:48 +0000
CC: linux-kernel@vger.kernel.org, kernel-janitors@vger.kernel.org, Christophe JAILLET <christophe.jaillet@wanadoo.fr>, Alex Elder <elder@linaro.org>, greybus-dev@lists.linaro.org, linux-staging@lists.linux.dev
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [greybus-dev] [PATCH v2] staging: greybus: Remove usage of the deprecated ida_simple_xx() API
List-Id: Greybus Development Mail List <greybus-dev.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/greybus-dev@lists.linaro.org/message/JJF26GA4OUAYVHHSFYDW7ZB6PMJE42MP/>
