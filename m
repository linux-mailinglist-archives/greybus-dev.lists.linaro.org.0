...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 6A8C7674A6A
	for <lists+greybus-dev@lfdr.de>; Fri, 20 Jan 2023 05:02:34 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 762913F081
	for <lists+greybus-dev@lfdr.de>; Fri, 20 Jan 2023 04:02:33 +0000 (UTC)
Received: from NAM11-BN8-obe.outbound.protection.outlook.com (mail-bn8nam11on2040.outbound.protection.outlook.com [40.107.236.40])
	by lists.linaro.org (Postfix) with ESMTPS id 600633EA37
	for <greybus-dev@lists.linaro.org>; Thu, 19 Jan 2023 18:55:07 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b=tzx9y9B8;
	spf=pass (lists.linaro.org: domain of amit.kumar-mahapatra@amd.com designates 40.107.236.40 as permitted sender) smtp.mailfrom=amit.kumar-mahapatra@amd.com;
...
Message-ID-Hash: LERLEG6IHANVNKYLICMG2RF52TZFM5TX
X-Message-ID-Hash: LERLEG6IHANVNKYLICMG2RF52TZFM5TX
...
Precedence: list
Subject: [greybus-dev] [PATCH v2 02/13] spi: Replace all spi->chip_select and spi->cs_gpiod references with function call
List-Id: Greybus Development Mail List <greybus-dev.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/greybus-dev@lists.linaro.org/message/LERLEG6IHANVNKYLICMG2RF52TZFM5TX/>
