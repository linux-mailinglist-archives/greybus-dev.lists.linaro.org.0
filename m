...
Received: from lists.linaro.org (lists.linaro.org [107.22.173.205])
	by mail.lfdr.de (Postfix) with ESMTPS id 977AC2007BB
	for <lists+greybus-dev@lfdr.de>; Fri, 19 Jun 2020 13:23:43 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id A7194665A1
	for <lists+greybus-dev@lfdr.de>; Fri, 19 Jun 2020 11:23:42 +0000 (UTC)
Received: by lists.linaro.org (Postfix, from userid 109)
	id 9C508665A5; Fri, 19 Jun 2020 11:23:42 +0000 (UTC)
...
X-Spam-Status: No, score=-2.9 required=5.0 tests=BAYES_00,DKIM_ADSP_CUSTOM_MED,
	...
	version=3.4.2
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 534F5665CF;
	Fri, 19 Jun 2020 11:22:28 +0000 (UTC)
X-Original-To: greybus-dev@lists.linaro.org
Delivered-To: greybus-dev@lists.linaro.org
Received: from lists.linaro.org (localhost [127.0.0.1])
 by lists.linaro.org (Postfix) with ESMTP id E4D6066597
 for <greybus-dev@lists.linaro.org>; Fri, 19 Jun 2020 11:22:06 +0000 (UTC)
Received: by lists.linaro.org (Postfix, from userid 109)
 id D5AED665A1; Fri, 19 Jun 2020 11:22:06 +0000 (UTC)
Received: from mail-pf1-f195.google.com (mail-pf1-f195.google.com
 [209.85.210.195])
 by lists.linaro.org (Postfix) with ESMTPS id D601966597
 for <greybus-dev@lists.linaro.org>; Fri, 19 Jun 2020 11:21:25 +0000 (UTC)
Received: by mail-pf1-f195.google.com with SMTP id j12so2082808pfn.10
 for <greybus-dev@lists.linaro.org>; Fri, 19 Jun 2020 04:21:25 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
 :references:mime-version:content-transfer-encoding;
 bh=xwA/Au2bjB/P91++xc6K+qE7ZLfaO7t7tCC6vL58JaA=;
 b=
X-Gm-Message-State: AOAM530RsEYymofjFUvsawMBnVV62q1LmQPVxbTTVDTpJyW3hyWzY/Jf
 V5klB0U0Hf0zkwcPgGjFHxk=
...
Subject: [greybus-dev] [PATCH v3 4/6] staging: greybus: audio: Resolve
...
ZDolZFxuIiwgd2lkLAogCQkJCSAgICBldmVudCwgcmV0KTsKIAotLSAKMi4yNi4yCgpfX19fX19f
