...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id C5F7A7B9C88
	for <lists+greybus-dev@lfdr.de>; Thu,  5 Oct 2023 12:39:59 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id C56173F97F
	for <lists+greybus-dev@lfdr.de>; Thu,  5 Oct 2023 10:39:58 +0000 (UTC)
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
	by lists.linaro.org (Postfix) with ESMTPS id 1E8AB40C18
	for <greybus-dev@lists.linaro.org>; Thu,  5 Oct 2023 10:39:51 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=linuxfoundation.org header.s=korg header.b=R2FvMBJK;
	spf=pass (lists.linaro.org: domain of gregkh@linuxfoundation.org designates 139.178.84.217 as permitted sender) smtp.mailfrom=gregkh@linuxfoundation.org;
	dmarc=pass (policy=none) header.from=linuxfoundation.org
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
	by dfw.source.kernel.org (Postfix) with ESMTP id 9ED16618F2;
...
X-Rspamd-Queue-Id: 1E8AB40C18
Message-ID-Hash: GD7HRDNN7O2IBLVQWMTDFDE7E4YETKXD
X-Message-ID-Hash: GD7HRDNN7O2IBLVQWMTDFDE7E4YETKXD
...
Archived-At: <https://lists.linaro.org/archives/list/greybus-dev@lists.linaro.org/message/GD7HRDNN7O2IBLVQWMTDFDE7E4YETKXD/>
