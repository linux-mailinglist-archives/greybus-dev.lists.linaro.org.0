...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 6773B969913
	for <lists+greybus-dev@lfdr.de>; Tue,  3 Sep 2024 11:33:31 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 7223344982
	for <lists+greybus-dev@lfdr.de>; Tue,  3 Sep 2024 09:33:30 +0000 (UTC)
Received: from mail-ot1-f65.google.com (mail-ot1-f65.google.com [209.85.210.65])
	by lists.linaro.org (Postfix) with ESMTPS id 7AF7F44336
	for <greybus-dev@lists.linaro.org>; Tue,  3 Sep 2024 09:33:26 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=beagleboard-org.20230601.gappssmtp.com header.s=20230601 header.b=1ukIt2aH;
	spf=neutral (lists.linaro.org: 209.85.210.65 is neither permitted nor denied by domain of ayush@beagleboard.org) smtp.mailfrom=ayush@beagleboard.org;
	dmarc=fail reason="No valid SPF, DKIM not aligned (relaxed)" header.from=beagleboard.org (policy=none)
Received: by mail-ot1-f65.google.com with SMTP id 46e09a7af769-70f645a30dcso2967546a34.3
        for <greybus-dev@lists.linaro.org>; Tue, 03 Sep 2024 02:33:26 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=beagleboard-org.20230601.gappssmtp.com; s=20230601; t=1725356006; x=1725960806; darn=lists.linaro.org;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=6E5UVxr4MQGPO+KigUydCl319tFmn78ypgRfuX/2iQE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=6E5UVxr4MQGPO+KigUydCl319tFmn78ypgRfuX/2iQE=;
        b=
X-Gm-Message-State: AOJu0Yy48n0hDPtZl1+vAMcgvJN9tFw0xycsSQe/qGDGA3YXfbq1W9DD
	WJFewsFcYgwmUWTe2qwTsynJnap7/KCh30Bzr5tYLyFqNB+BEApDQlC0sdRTpA==
...
X-Spamd-Result: default: False [-5.80 / 15.00];
	...
	RWL_MAILSPIKE_GOOD(-0.10)[209.85.210.65:from];
...
Message-ID-Hash: ILIOX47FPCZMLUWIZ6MTK6JJW2VHHIZ7
X-Message-ID-Hash: ILIOX47FPCZMLUWIZ6MTK6JJW2VHHIZ7
...
Precedence: list
Subject: [greybus-dev] [PATCH v4 3/3] greybus: gb-beagleplay: Add firmware upload API
List-Id: Greybus Development Mail List <greybus-dev.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/greybus-dev@lists.linaro.org/message/ILIOX47FPCZMLUWIZ6MTK6JJW2VHHIZ7/>
