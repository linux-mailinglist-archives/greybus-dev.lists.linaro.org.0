...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D9D998FFEC
	for <lists+greybus-dev@lfdr.de>; Fri,  4 Oct 2024 11:41:29 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 0E25A448AA
	for <lists+greybus-dev@lfdr.de>; Fri,  4 Oct 2024 09:41:28 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.11])
	by lists.linaro.org (Postfix) with ESMTPS id 32EC940F33
	for <greybus-dev@lists.linaro.org>; Fri,  4 Oct 2024 09:41:23 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=intel.com header.s=Intel header.b=ZN5fD5Uv;
	dmarc=pass (policy=none) header.from=intel.com;
	spf=none (lists.linaro.org: domain of sakari.ailus@linux.intel.com has no SPF policy when checking 192.198.163.11) smtp.mailfrom=sakari.ailus@linux.intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=ZN5fD5UvofC92t4L7UgTccFeBnkHKA4gW+QJZKHaDL/Ano8dChLMzHj8
   ...
   Q==;
X-CSE-ConnectionGUID: 9h5sM+M+RDe+PeC8RGqyBw==
X-CSE-MsgGUID: 9iYCdOxEQCC9I+TTpBoS8w==
X-IronPort-AV: E=McAfee;i="6700,10204,11214"; a="37856213"
X-IronPort-AV: E=Sophos;i="6.11,177,1725346800";
   d="scan'208";a="37856213"
...
X-Spamd-Result: default: False [-0.80 / 15.00];
	...
	FROM_HAS_DN(0.00)[];
	FREEMAIL_CC(0.00)[ideasonboard.com,kernel.org,gmail.com];
	TO_DN_SOME(0.00)[];
...
Message-ID-Hash: YMSQBLLLZTWKLHEXHBVTXG6YS2RSHKEH
X-Message-ID-Hash: YMSQBLLLZTWKLHEXHBVTXG6YS2RSHKEH
X-MailFrom: sakari.ailus@linux.intel.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; digests; suspicious-header
CC: laurent.pinchart@ideasonboard.com, rafael@kernel.org, Andy Shevchenko <andy.shevchenko@gmail.com>
X-Mailman-Version: 3.3.5
Precedence: list
Subject: [greybus-dev] [PATCH 00/51] treewide: Switch to __pm_runtime_put_autosuspend()
List-Id: Greybus Development Mail List <greybus-dev.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/greybus-dev@lists.linaro.org/message/YMSQBLLLZTWKLHEXHBVTXG6YS2RSHKEH/>
