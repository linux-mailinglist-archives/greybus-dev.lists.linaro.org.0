...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 0346295E471
	for <lists+greybus-dev@lfdr.de>; Sun, 25 Aug 2024 18:47:54 +0200 (CEST)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 11E2544312
	for <lists+greybus-dev@lfdr.de>; Sun, 25 Aug 2024 16:47:53 +0000 (UTC)
Received: from mail-pg1-f195.google.com (mail-pg1-f195.google.com [209.85.215.195])
	by lists.linaro.org (Postfix) with ESMTPS id 14ADE40D1A
	for <greybus-dev@lists.linaro.org>; Sun, 25 Aug 2024 16:47:49 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=beagleboard-org.20230601.gappssmtp.com header.s=20230601 header.b=dAvKt6ow;
	spf=neutral (lists.linaro.org: 209.85.215.195 is neither permitted nor denied by domain of ayush@beagleboard.org) smtp.mailfrom=ayush@beagleboard.org;
	dmarc=fail reason="No valid SPF, DKIM not aligned (relaxed)" header.from=beagleboard.org (policy=none)
Received: by mail-pg1-f195.google.com with SMTP id 41be03b00d2f7-7c3d8f260easo2054426a12.1
        for <greybus-dev@lists.linaro.org>; Sun, 25 Aug 2024 09:47:49 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=beagleboard-org.20230601.gappssmtp.com; s=20230601; t=1724604468; x=1725209268; darn=lists.linaro.org;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=HqKJOoYh+6QDm3mjDAuqJ+dWyDs9Vqx8ITMW9/hp9Qo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=HqKJOoYh+6QDm3mjDAuqJ+dWyDs9Vqx8ITMW9/hp9Qo=;
        b=
X-Gm-Message-State: AOJu0Yzxe8ruhplaIONvJnPCUOFRwTYdzII1vVeMdmEH9oEVFg1SLyZ+
	u+xTJsG4qYFaS9cZPIWR4ck/qRSx4VFLxWdN9RVFLlUrIUrPfraf+jOb40PJqQ==
...
Message-ID-Hash: 4YR4IP7O4O7DHNO2BPX27ENVZRM2ZRBM
X-Message-ID-Hash: 4YR4IP7O4O7DHNO2BPX27ENVZRM2ZRBM
...
Precedence: list
Subject: [greybus-dev] [PATCH v3 3/3] greybus: gb-beagleplay: Add firmware upload API
List-Id: Greybus Development Mail List <greybus-dev.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/greybus-dev@lists.linaro.org/message/4YR4IP7O4O7DHNO2BPX27ENVZRM2ZRBM/>
