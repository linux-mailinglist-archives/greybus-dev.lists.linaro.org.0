...
Received: from lists.linaro.org (lists.linaro.org [3.208.193.21])
	by mail.lfdr.de (Postfix) with ESMTPS id 4746F674A72
	for <lists+greybus-dev@lfdr.de>; Fri, 20 Jan 2023 05:03:13 +0100 (CET)
Received: from lists.linaro.org (localhost [127.0.0.1])
	by lists.linaro.org (Postfix) with ESMTP id 543D43F07C
	for <lists+greybus-dev@lfdr.de>; Fri, 20 Jan 2023 04:03:12 +0000 (UTC)
Received: from NAM04-DM6-obe.outbound.protection.outlook.com (mail-dm6nam04on2046.outbound.protection.outlook.com [40.107.102.46])
	by lists.linaro.org (Postfix) with ESMTPS id AF9C13EF35
	for <greybus-dev@lists.linaro.org>; Thu, 19 Jan 2023 18:58:07 +0000 (UTC)
Authentication-Results: lists.linaro.org;
	dkim=pass header.d=amd.com header.s=selector1 header.b="Zxxb6A/Z";
	spf=pass (lists.linaro.org: domain of amit.kumar-mahapatra@amd.com designates 40.107.102.46 as permitted sender) smtp.mailfrom=amit.kumar-mahapatra@amd.com;
...
X-Spamd-Result: default: False [-3.50 / 15.00];
 ...
 com,m:yogeshgaur.83@gmail.com,m:konrad.dybcio@somainline.org,m:alim.akhtar@samsung.com,m:ldewangan@nvidia.com,m:michal.simek@amd.com,m:linux-aspeed@lists.ozlabs.org,m:openbmc@lists.ozlabs.org,m:linux-arm-kernel@lists.infradead.org,m:linux-rpi-kernel@lists.infradead.org,m:linux-amlogic@lists.infradead.org,m:linux-mediatek@lists.infradead.org,m:linux-arm-msm@vger.kernel.org,m:linux-rockchip@lists.infradead.org,m:linux-samsung-soc@vger.kernel.org,m:linux-stm32@st-md-mailman.stormreply.com,m:linux-sunxi@lists.linux.dev,s:greybus-dev@lists.linaro.org];
	...
	RWL_MAILSPIKE_POSSIBLE(0.00)[40.107.102.46:from];
...
X-Rspamd-Queue-Id: AF9C13EF35
X-Spamd-Bar: ---
X-MailFrom: amit.kumar-mahapatra@amd.com
X-Mailman-Rule-Hits: max-recipients
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-size; news-moderation; no-subject; digests; suspicious-header
Message-ID-Hash: BD6ZVY7DYYTZTYTUEVPEMZD2XEQZ44SI
X-Message-ID-Hash: BD6ZVY7DYYTZTYTUEVPEMZD2XEQZ44SI
...
Precedence: list
Subject: [greybus-dev] [PATCH v2 09/13] mtd: spi-nor: Add APIs to set/get nor->params
List-Id: Greybus Development Mail List <greybus-dev.lists.linaro.org>
Archived-At: <https://lists.linaro.org/archives/list/greybus-dev@lists.linaro.org/message/BD6ZVY7DYYTZTYTUEVPEMZD2XEQZ44SI/>
